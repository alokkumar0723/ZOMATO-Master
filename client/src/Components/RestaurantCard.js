...
const RestaurantCard = (props) => {
  ...
  return (
    <Link to={`/restaurant/1234567`} className='w-full  md:w-1/2 lg:w-1/3 '>
      <div className='bg-white p-4 mb-4 rounded-2xl transition duration-700 ease-in-out hover:shadow-lg'>
        <div className='w-full h-56 lg:h-64 relative'>
          ...
          <img
            src='https://b.zmtcdn.com/data/pictures/chains/9/19015209/3a12ece4f7c57200da8ae68d9b558f8c_o2_featured_v2.jpeg?output-format=webp'
            alt='food'
